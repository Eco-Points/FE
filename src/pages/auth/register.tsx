    ...
    <Layout>
      <div className="flex flex-col items-center justify-center py-4 px-4 md:py-8">
        <div className="bg-white shadow-md rounded-lg p-8 w-full max-w-md">
          ...
          <Form {...form}>
            <form data-testid="form-register" onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div className="text-center mt-4">
            <p className="text-green-500">
              Sudah punya akun?{" "}
              <Link to="/login" className="text-green-500 hover:text-green-600 font-medium" data-testid="link-login">
                Masuk di sini.
              </Link>
            </p>
          </div>
