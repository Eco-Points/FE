  ...
  return (
    <div className="flex min-h-[100dvh] flex-col items-center justify-center px-4 py-12 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-md text-center">
        ...
        <h1 className="mt-4 text-3xl font-bold tracking-tight text-slate-800 sm:text-4xl">Halaman Tidak Ditemukan</h1>
        <p className="mt-4 text-slate-400">Maaf, halaman yang Anda cari tidak dapat ditemukan. Silakan periksa kembali URL atau kembali ke halaman utama.</p>
        <div className="mt-6">
          <Link
            to={redirectTo}
